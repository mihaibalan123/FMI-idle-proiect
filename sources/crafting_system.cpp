...
bool crafting_logic(player& p, item* i1, item* i2, int idx1, int idx2, func create_item) {
    const auto* obj1 = dynamic_cast<const type*>(i1);
    const auto* obj2 = dynamic_cast<const type*>(i2);

    if (obj1 && obj2) {
        if (auto new_item = create_item(obj1, obj2)) {
...
bool crafting_system::try_combine_books(player& p, item* i1, item* i2, int idx1, int idx2) {
    return crafting_logic<book>(p, i1, i2, idx1, idx2,
...
bool crafting_system::try_combine_drinks(player& p, item* i1, item* i2, int idx1, int idx2) {
    return crafting_logic<drink>(p, i1, i2, idx1, idx2,
        [](const drink* d1, const drink* d2) {
...
bool crafting_system::try_combine_sheets(player& p, item* i1, item* i2, int idx1, int idx2) {
    return crafting_logic<cheating_sheet>(p, i1, i2, idx1, idx2,
        [](const cheating_sheet* s1, const cheating_sheet* s2) {
